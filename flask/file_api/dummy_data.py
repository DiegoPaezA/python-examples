...
films = {
    'Name' : ['Inception', 'In time', 'The Intouchables', 'Source Code', 'Avatar', 'Pinochhio', 'Megan', 'Everything everywhere all at once ', 'Jumanji 2', 'The Whale', 'Harry Potter', 'Captain America', 'The Avengers', 'Under the Skin', 'Sing 2'],
